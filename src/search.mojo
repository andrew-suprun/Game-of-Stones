...
fn search[Tree: Negamax](game: Tree.Game, duration_ms: UInt) -> MoveScore[Tree.Game.Move]:
...
struct BasicNegamax[G: TGame](Negamax):
    ...
    fn search(mut self, game: Self.Game, depth: Int, deadline: UInt) -> MoveScore[G.Move]:
