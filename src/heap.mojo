struct Heap[T: Copyable & ImplicitlyDestructible, size: Int]:
    ...
    fn add(
        ...
        if len(self.items) == Self.size:
            ...
            while True:
                ...
                if left_child_idx < len(self.items) and less(
                ...
                if (
                    ...
                    and less(self.items[right_child_idx], item)
                    and less(
